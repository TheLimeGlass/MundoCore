...
public interface DocumentationBuilder<D extends DocumentationElement, B extends DocumentationBuilder<D, B>> {
    ...
    class Expression extends Changeable<DocumentationElement.Expression, Expression> {
        ...
        public DocumentationElement.Expression build() {
            ...
            return new DocumentationElement.Expression(name, category, syntaxes, description, originVersion, Classes.getExactClassInfo(returnType), requiredPlugins, examples, changerBuilders);
        }
    }
    ...
    class EventValue {
        ...
        public DocumentationElement.EventValue build(DocumentationElement.Event parent) {
            ...
            return new DocumentationElement.EventValue(parent, classInfo == null ? type.getName() : classInfo.getCodeName(), description, originVersion);
        }
    }
