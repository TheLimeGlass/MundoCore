package us.tlatoani.mundocore.reflection;
...
/*
* This class was borrowed from the ProtocolLib GitHub for use in this plugin,
* no credit is claimed by the creator of this plugin for this code.
* Note: Some code has been added to the original class,
* that code is specified by MODIFICATIONS  START and MODIFICATIONS END.
* */
