package us.tlatoani.mundocore.registration_enum;
...
import us.tlatoani.mundocore.registration.DocumentationElement;
import us.tlatoani.mundocore.registration.MundoClassInfo;
...
public class EnumClassInfo<E> extends MundoClassInfo<E> {
    ...
    public static <E> EnumClassInfo<E> registerEnum(Class<E> enumClass, String name, E... values) {
        EnumClassInfo<E> enumClassInfo = new EnumClassInfo<E>(enumClass, new String[]{name}, Registration.getCurrentCategory(), values);
        if (Registration.classInfoSafe(enumClass, name)) {
            Classes.registerClass(enumClassInfo);
            ExprEnumValues.addEnumClassInfo(enumClassInfo);
        }
        return enumClassInfo.requiredPlugins(Registration.getCurrentRequiredPlugins());
    }
    ...
    public static <E> EnumClassInfo<E> registerEnum(Class<E> enumClass, String name, Map<String, E> valueMap) {
        EnumClassInfo<E> enumClassInfo = new EnumClassInfo<E>(enumClass, new String[]{name}, Registration.getCurrentCategory(), valueMap);
        if (Registration.classInfoSafe(enumClass, name)) {
            Classes.registerClass(enumClassInfo);
            ExprEnumValues.addEnumClassInfo(enumClassInfo);
        }
    ...
    private void afterInitialization() {
        ...
        serializer(new Serializer<E>() {
            ...
            public boolean canBeInstantiated(Class<? extends E> c) {
